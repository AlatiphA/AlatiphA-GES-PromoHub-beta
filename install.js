/* =====================================================
   AlatiphA GES PromoHub — PWA Install Prompt
   install.js
   ─────────────────────────────────────────────────
...
(function() {
  ...
  const INSTALL_KEY = "gespromohub_install_dismissed";
  const dismissed =
  ...
  function showInstallBanner() {
    ...
    banner.innerHTML = `
      ...
      <div class="ib-text">
        <div class="ib-title">AlatiphA GES PromoHub</div>
